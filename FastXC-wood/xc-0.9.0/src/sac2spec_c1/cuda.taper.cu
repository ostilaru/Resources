                                      ...
                                      int idx1, int idx2, int idx3, int idx4)
{
  ...
  if (col < width && row < height)
  {
    ...
    {
      ntrans = idx2 - idx1;
      double x = (double)(col - idx1) / ntrans;
      factor = sin(M_PI * x) / (M_PI * x);
      factor = (col == idx1) ? 1.0 : factor; // Handle the x = 0 case
    ...
    {
      ntrans = idx4 - idx3;
      double x = (double)(col - idx3) / ntrans;
      factor = sin(M_PI * x) / (M_PI * x);
      factor = (col == idx3) ? 1.0 : factor; // Handle the x = 0 case
